...
setuptools.setup(
    name="alma-hilse",
    version="0.3.1",
    description="ALMA Hardware-In-the-Loop Simulation Environment setup, monitoring and verification package",
    ...
    license="MIT",
    install_requires=["click==8.0.4", "typer==0.4.0", "rich==12.0.0"],
